...
public class ComeandeatServiceTest {
	...
	public void testSuite() {
		...
		Reviews review1FP2 = createReview(foodProvider1, 1, "sdfaf");
		Reviews review2FP2 = createReview(foodProvider1, 1, "sdfaf");
		Reviews review3FP2 = createReview(foodProvider1, 3, "sdfaf");
		Reviews review4FP2 = createReview(foodProvider1, 3, "sdfaf");
		Reviews review5FP2 = createReview(foodProvider1, 3, "sdfaf");
		...
		assertTrue(IterableUtils.size(reviews)==5);
	...
	private OrderMenuItem createOrderMenuItem(FoodProvider foodProvider, MenuItem menuItem, FoodOrder foodOrder, Addition addition) {
